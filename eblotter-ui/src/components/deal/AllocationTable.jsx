              ...
              <tr key={rowIndex} className={getRowClassName(row)}>
                ...
                <td className="cell-editable">
                  <input
                    type="text"
                    value={row.col4}
                    onChange={(e) => handleCellChange(rowIndex, 'col4', e.target.value)}
                  />
                </td>
                <td className="cell-editable">
                  <input
                    type="text"
                    value={row.col5}
                    onChange={(e) => handleCellChange(rowIndex, 'col5', e.target.value)}
                  />
                </td>
                <td className="cell-editable">
                  <input
                ...
                <td className="cell-editable">
                  <input
                    type="text"
                    value={row.col7}
                    onChange={(e) => handleCellChange(rowIndex, 'col7', e.target.value)}
                  />
                </td>
                <td className="cell-editable">
                  <input
